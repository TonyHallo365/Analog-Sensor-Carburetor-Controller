...
const int numReadingsS = 100; // Number of readings to average (e.g., 8)
...
sportData getSensorData4(CustomSPortSensor*);
sportData getSensorData5(CustomSPortSensor*);
